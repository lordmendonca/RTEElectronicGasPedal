 ...
 * @param const sc_engine_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_ENGINE_init( SC_ENGINE_t * const signal, const SC_ENGINE_data_t * const value )
{                                                                                                                      
