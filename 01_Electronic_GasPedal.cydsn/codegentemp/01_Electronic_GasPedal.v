// ======================================================================
// 01_Electronic_GasPedal.v generated from TopDesign.cysch
// 05/27/2022 at 08:50
...
module ADC_SAR_SEQ_v2_10_4 (
	...
	cy_clock_v1_0
		#(.id("0e799d97-72bb-4edc-9a32-f8eda6729941/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("0e799d97-72bb-4edc-9a32-f8eda6729941/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("530052ab-d9e3-4287-8893-79e4bced2b5a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b330f97f-c7f3-45ea-96aa-c60706b35c3b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a1bdf7d7-23f5-435d-b3bb-4fcef7a8d1ce"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("424b7380-cd1a-4790-b2e4-9e65e59f5cc4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6b88ebab-6e40-45cc-8448-e123cf47c690"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("333c360e-fb4f-474d-ab03-20a66aa783c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("80b8381d-c6ef-47f2-a764-57af05550356"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    ADC_SAR_SEQ_v2_10_4 JOYSTICK_ADC_XY (
        .aclk(1'b0),
        .AIN_10(Net_115),
        .AIN_100(Net_116),
        .AIN_101(Net_117),
	...
	cy_psoc3_pins_v1_10
		#(.id("39dc8d3f-7258-4ff4-afdb-3c23f96d0f6c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__testWDT_net;
	wire [0:0] tmpIO_0__testWDT_net;
	wire [0:0] tmpINTERRUPT_0__testWDT_net;
	electrical [0:0] tmpSIOVREF__testWDT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("90513de8-abba-4365-9d3d-7b62281d0054"),
		  ...
		  .input_buffer_sel(2'b00))
		testWDT
		 (.oe(tmpOE__testWDT_net),
		  .y({1'b0}),
		  .fb({Net_646}),
		  .io({tmpIO_0__testWDT_net[0:0]}),
		  .siovref(tmpSIOVREF__testWDT_net),
		  .interrupt({tmpINTERRUPT_0__testWDT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__testWDT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OSShutdown_net;
	wire [0:0] tmpIO_0__OSShutdown_net;
	wire [0:0] tmpINTERRUPT_0__OSShutdown_net;
	electrical [0:0] tmpSIOVREF__OSShutdown_net;

	cy_psoc3_pins_v1_10
		#(.id("4093bafb-f715-44cc-8b61-3880bcb009a5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OSShutdown
		 (.oe(tmpOE__OSShutdown_net),
		  .y({1'b0}),
		  .fb({Net_650}),
		  .io({tmpIO_0__OSShutdown_net[0:0]}),
		  .siovref(tmpSIOVREF__OSShutdown_net),
		  .interrupt({tmpINTERRUPT_0__OSShutdown_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OSShutdown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
